...
Documentation       UC1_AC1: As the Clerk, I should be able to insert a single record of working class hero into database via an API


*** Test Cases ***
Insert valid person detail
...
Verify Insert Endpoint should not accept Invalid Birthdate
...
Verify Insert Endpoint should not accept Gender more than 1 character
    [Tags]      regression  negative_tc
    Create Session    session    ${app_url}
